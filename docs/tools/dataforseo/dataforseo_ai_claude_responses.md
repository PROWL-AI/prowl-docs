---
name: dataforseo_ai_claude_responses
provider: DataForSEO
...
Get structured Claude AI responses via DataForSEO — generate AI responses with Anthropic Claude models.
...
```json
{
  ...
  "tool_name": "dataforseo_ai_claude_responses",
  "params": {
    "user_prompt": "example"
  }
}
...
| `use_reasoning` | boolean | no |  | enable reasoning for the AI model |
...
| `user_prompt` | string | yes |  | Prompt for Claude (max 500 chars) |
| `model_name` | string | no |  | Claude model name (e.g. claude-opus-4-0). See /v3/ai_optimization/claude/llm_responses/models. |
...
```json
{
  ...
  "properties": {
    ...
    "use_reasoning": {
      "type": "boolean",
      "description": "enable reasoning for the AI model"
    },
    "web_search_city": {
      "type": "string",
    ...
    "user_prompt": {
      "type": "string",
      "description": "Prompt for Claude (max 500 chars)"
    },
    "model_name": {
      "type": "string",
      "description": "Claude model name (e.g. claude-opus-4-0). See /v3/ai_optimization/claude/llm_responses/models."
    },
    "max_output_tokens": {
      "type": "integer",
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0612-0000-e803da7c4906",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "4.6837 sec.",
      "cost": 0.003582,
...
- Anthropic Claude API responses for AI visibility analysis — third LLM perspective alongside ChatGPT and Gemini.
