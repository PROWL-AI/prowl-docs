---
name: dataforseo_ai_gemini_responses
provider: DataForSEO
...
Get structured Gemini AI responses via DataForSEO.
...
```json
{
  ...
  "tool_name": "dataforseo_ai_gemini_responses",
  "params": {
    "user_prompt": "example"
  }
}
...
| `user_prompt` | string | yes |  | Prompt for Gemini (max 500 chars) |
| `model_name` | string | no |  | Gemini model name (e.g. gemini-1.5-pro). See /v3/ai_optimization/gemini/llm_responses/models. |
...
```json
{
  ...
  "properties": {
    ...
    "user_prompt": {
      "type": "string",
      "description": "Prompt for Gemini (max 500 chars)"
    },
    "model_name": {
      "type": "string",
      "description": "Gemini model name (e.g. gemini-1.5-pro). See /v3/ai_optimization/gemini/llm_responses/models."
    },
    "max_output_tokens": {
      "type": "integer",
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0612-0000-66ebd8117797",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "1.8840 sec.",
      "cost": 0.001413,
