---
name: dataforseo_ai_keyword_volume
provider: DataForSEO
...
Get AI-specific keyword search volume — estimated usage of keywords in AI tools.
...
```json
{
  ...
  "tool_name": "dataforseo_ai_keyword_volume",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0619-0000-f6c27035876e",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.3372 sec.",
      "cost": 0.0102,
