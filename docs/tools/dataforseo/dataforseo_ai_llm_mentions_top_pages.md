---
name: dataforseo_ai_llm_mentions_top_pages
provider: DataForSEO
...
Get top pages mentioned by AI for a keyword — see which specific URLs AI cites most.
...
```json
{
  ...
  "tool_name": "dataforseo_ai_llm_mentions_top_pages",
  "params": {
    "target": "example.com"
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0638-0000-e179852cd8f6",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.6867 sec.",
      "cost": 0.101,
...
- Specific pages most cited by AI platforms for a keyword/topic.
- Input: target (keyword/topic), optional location_name, language_name, limit.
- Actionable for content optimization — identify what content formats/pages AI cites.
