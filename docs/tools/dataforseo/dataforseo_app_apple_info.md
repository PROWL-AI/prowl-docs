---
name: dataforseo_app_apple_info
provider: DataForSEO
...
# `dataforseo_app_apple_info`

Get detailed App Store app info — description, rating, reviews, images, and price.
...
```json
{
  ...
  "tool_name": "dataforseo_app_apple_info",
  "params": {
...
| `app_id` | string | yes |  | App Store app ID |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0419-0000-8613869c223f",
      "status_code": 20100,
