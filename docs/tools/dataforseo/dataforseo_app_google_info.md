---
name: dataforseo_app_google_info
provider: DataForSEO
...
Get detailed Google Play app info — description, rating, installs, reviews, images.
...
```json
{
  ...
  "tool_name": "dataforseo_app_google_info",
  "params": {
...
| `app_id` | string | yes |  | Google Play app ID (e.g. 'com.google.android.apps.maps') |
...
```json
{
  ...
  "properties": {
    ...
    "app_id": {
      "type": "string",
      "description": "Google Play app ID (e.g. 'com.google.android.apps.maps')"
    },
    "location_name": {
      "type": "string",
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0419-0000-c98716a74c35",
      "status_code": 20100,
