---
name: dataforseo_app_google_searches
provider: DataForSEO
...
Search Google Play Store — find apps ranking for a keyword.
...
```json
{
  ...
  "tool_name": "dataforseo_app_google_searches",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0428-0000-3d32d74bcef5",
      "status_code": 20100,
