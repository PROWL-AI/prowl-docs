---
name: dataforseo_biz_google_my_business_info
provider: DataForSEO
...
# `dataforseo_biz_google_my_business_info`

Get Google My Business profile info — address, phone, rating, hours, and description.
...
```json
{
  ...
  "tool_name": "dataforseo_biz_google_my_business_info",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0572-0000-f35d52212dc2",
      "status_code": 40102,
