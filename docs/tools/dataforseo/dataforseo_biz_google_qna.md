---
name: dataforseo_biz_google_qna
provider: DataForSEO
...
Get Google Questions & Answers for a business — user-submitted Q&A from Google Business profile.
...
```json
{
  ...
  "tool_name": "dataforseo_biz_google_qna",
  "params": {
...
| `depth` | integer | no |  | Number of results to return (max 100) |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0578-0000-764a3503f09e",
      "status_code": 40102,
...
- Google Q&A data for businesses — reveals pre-purchase objections and competitor comparisons from potential customers.
