---
name: dataforseo_biz_social_pinterest
provider: DataForSEO
...
# `dataforseo_biz_social_pinterest`

Get Pinterest social media metrics — pins and saves for up to 1000 URLs.
...
```json
{
  ...
  "tool_name": "dataforseo_biz_social_pinterest",
  "params": {
    "targets": []
  }
}
...
| `tasks[].result[].page_url` | string |  |
| `tasks[].result[].pins_count` | null |  |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0322-0000-a35563cfedb3",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "1.2856 sec.",
      "cost": 8e-05,
...
- Pinterest profile metrics — followers, pins, boards. Only available from DataForSEO. Essential for e-commerce brands.
