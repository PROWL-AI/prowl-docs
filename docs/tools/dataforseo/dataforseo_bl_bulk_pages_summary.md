---
name: dataforseo_bl_bulk_pages_summary
provider: DataForSEO
...
# `dataforseo_bl_bulk_pages_summary`

Get page-level backlink summary for up to 1000 URLs — backlinks, referring domains, rank per page.
...
```json
{
  ...
  "tool_name": "dataforseo_bl_bulk_pages_summary",
  "params": {
    "targets": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0576-0000-74075fe604dd",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0667 sec.",
      "cost": 0.024072,
...
- Page-level backlink summary for up to 1000 URLs. Returns backlinks count, referring domains, rank per page.
- Input: targets (list of URLs).
- Compare specific landing page authority across competitors.
