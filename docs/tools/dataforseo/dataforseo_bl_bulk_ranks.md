...
Get rank scores for up to 1000 domains/pages — 0-1000 scale based on backlink profile (like PageRank).
...
```json
{
  ...
  "tool_name": "dataforseo_bl_bulk_ranks",
  "params": {
    "targets": []
  }
}
...
| `tasks[].result[].items[].rank` | integer |  |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0347-0000-76ecc80482d8",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0068 sec.",
      "cost": 0.024072,
...
- Rank scores (0-1000) for up to 1000 domains/pages in one request. Based on backlink profile quality.
- Input: targets (list of up to 1000 URLs/domains).
- Efficient for comparing authority across many competitors simultaneously.
