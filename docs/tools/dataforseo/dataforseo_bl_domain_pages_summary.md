---
name: dataforseo_bl_domain_pages_summary
provider: DataForSEO
...
Get backlink summary per page of a domain — identify which pages attract the most links.
...
```json
{
  ...
  "tool_name": "dataforseo_bl_domain_pages_summary",
  "params": {
    "target": "example.com"
  }
}
...
| `include_subdomains` | boolean | no |  | indicates if the subdomains of the target domain will be included in the search |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0445-0000-d5d826ee5476",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "18.8115 sec.",
      "cost": 0.0276,
...
- All pages on a domain with backlink metrics. Returns per-page: backlinks count, referring domains, page rank.
- Input: target, optional limit, order_by (e.g. ['page_rank,desc']), filters.
- Find which competitor pages attract the most links to replicate their content strategy.
