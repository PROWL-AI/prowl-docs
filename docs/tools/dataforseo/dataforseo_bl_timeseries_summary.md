---
name: dataforseo_bl_timeseries_summary
provider: DataForSEO
...
Get backlink profile trends over time — daily/weekly backlink and referring domain counts.
...
```json
{
  ...
  "tool_name": "dataforseo_bl_timeseries_summary",
  "params": {
    "target": "example.com"
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0459-0000-38f5f10e910f",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0182 sec.",
      "cost": 0.027312,
...
- Backlink profile trends over time. Returns daily/weekly: total backlinks, referring domains, rank.
- Input: target, optional date_from/date_to (YYYY-MM-DD).
- Essential for detecting link velocity trends and authority trajectory.
