---
name: dataforseo_content_sentiment
provider: DataForSEO
...
Get sentiment analysis for keyword citations — positive, negative, neutral breakdown.
...
```json
{
  ...
  "tool_name": "dataforseo_content_sentiment",
  "params": {
...
| `tasks[].result[].positive_connotation_distribution` | object |  |
| `tasks[].result[].positive_connotation_distribution.positive` | object |  |
| `tasks[].result[].positive_connotation_distribution.positive.type` | string |  |
| `tasks[].result[].positive_connotation_distribution.positive.total_count` | integer |  |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0465-0000-9b25b1050fc3",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "15.2371 sec.",
      "cost": 0.024036,
