---
name: dataforseo_content_summary
provider: DataForSEO
...
# `dataforseo_content_summary`

Get content citation summary — total mentions, sentiment distribution, top domains for a keyword.
...
```json
{
  ...
  "tool_name": "dataforseo_content_summary",
  "params": {
...
| `tasks[].result[].top_domains[]` | array<object> |  |
| `tasks[].result[].top_domains[].domain` | string |  |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0464-0000-9c3a8d00cfdc",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "2.2149 sec.",
      "cost": 0.024036,
