---
name: dataforseo_domain_domains_by_technology
provider: DataForSEO
...
Find domains using specific technologies — discover sites using React, WordPress, Shopify, etc.
...
```json
{
  ...
  "tool_name": "dataforseo_domain_domains_by_technology",
  "params": {}
}
```
...
| `keywords` | any[] | no |  | target keywords in the domain’s title, description or meta keywords |
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111840-1544-0484-0000-aec85c5a709e",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.7022 sec.",
      "cost": 0.132,
