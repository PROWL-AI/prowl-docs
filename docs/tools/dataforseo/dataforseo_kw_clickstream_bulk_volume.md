---
name: dataforseo_kw_clickstream_bulk_volume
provider: DataForSEO
...
Get bulk clickstream search volume with historical data for up to 1000 keywords.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_clickstream_bulk_volume",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0591-0000-5fe6d39de5ca",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.2484 sec.",
      "cost": 0.01224,
