---
name: dataforseo_kw_clickstream_search_volume
provider: DataForSEO
...
Get clickstream-based search volume normalized with Bing data — more accurate than Google Ads for real user behavior.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_clickstream_search_volume",
  "params": {
    "keywords": []
  }
}
...
| `use_clickstream` | boolean | no |  | use clickstream data to provide results |
...
```json
{
  ...
  "properties": {
    ...
    "use_clickstream": {
      "type": "boolean",
      "description": "use clickstream data to provide results"
    },
    "keywords": {
      "type": "array",
      "items": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0589-0000-1c63f722184e",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "1.8224 sec.",
      "cost": 0.18,
