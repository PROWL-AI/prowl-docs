---
name: dataforseo_kw_dataforseo_trends_explore
provider: DataForSEO
...
Explore DataForSEO Trends — keyword popularity over time from DataForSEO's own clickstream data.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_dataforseo_trends_explore",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111846-1544-0570-0000-55b5bdbc46cd",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "1.0254 sec.",
      "cost": 0.0012,
...
- Keyword interest over time with finer date granularity and category filtering than Google Trends.
