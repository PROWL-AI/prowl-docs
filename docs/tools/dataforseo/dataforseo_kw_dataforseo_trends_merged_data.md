---
name: dataforseo_kw_dataforseo_trends_merged_data
provider: DataForSEO
...
Get merged trends data — combined keyword trends with volume, clicks, and demographic data.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_dataforseo_trends_merged_data",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111846-1544-0575-0000-011adcce9def",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.7042 sec.",
      "cost": 0.006,
...
- Combined trend data merging multiple signals into a unified view for comprehensive trend analysis.
