---
name: dataforseo_kw_dataforseo_trends_subregion_interests
provider: DataForSEO
...
# `dataforseo_kw_dataforseo_trends_subregion_interests`

Get regional interest data for keywords — search popularity broken down by subregions.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_dataforseo_trends_subregion_interests",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111846-1544-0573-0000-53c584a78442",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "1.0831 sec.",
      "cost": 0.0024,
...
- Geographic distribution of search interest at subregion level for geo-targeting analysis.
