---
name: dataforseo_kw_google_ads_keywords_for_keywords
provider: DataForSEO
...
Get keyword suggestions from Google Ads based on seed keywords — expand keyword lists.
...
```json
{
  ...
  "tool_name": "dataforseo_kw_google_ads_keywords_for_keywords",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0368-0000-5f8d5697cd63",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "72.8604 sec.",
      "cost": 0.09,
