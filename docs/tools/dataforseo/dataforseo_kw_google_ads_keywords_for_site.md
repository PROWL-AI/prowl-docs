---
name: dataforseo_kw_google_ads_keywords_for_site
provider: DataForSEO
...
Get relevant keywords for a website from Google Ads data — discover what keywords a domain could target.
...
| Tags | `ads`, `dataforseo`, `google`, `keywords` |
...
```json
{
  ...
  "tool_name": "dataforseo_kw_google_ads_keywords_for_site",
  "params": {
    "target": "example.com"
  }
}
...
| `target_type` | enum(site, page) | no |  | search keywords for site or for url |
...
```json
{
  ...
  "properties": {
    ...
    "target_type": {
      "type": "string",
      "description": "search keywords for site or for url",
      "enum": [
        "site",
        "page"
      ]
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0369-0000-a0eb468c44ba",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "89.4131 sec.",
      "cost": 0.09,
...
- `dataforseo_labs_keywords_for_site`
