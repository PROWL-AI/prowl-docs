---
name: dataforseo_kw_google_ads_search_volume
provider: DataForSEO
...
Get Google Ads keyword search volume, CPC, competition, and monthly trends for up to 1000 keywords.
...
| Tags | `ads`, `dataforseo`, `google`, `search` |
...
```json
{
  ...
  "tool_name": "dataforseo_kw_google_ads_search_volume",
  "params": {
    "keywords": []
  }
}
...
|-------|------|----------|---------|-------------|
| `include_adult_keywords` | boolean | no |  | include keywords associated with adult content |
...
| `sort_by` | enum(relevance) | no |  | Sort field (DataForSEO supports 'relevance' for Google Ads search_volume; pass null to use default server order) |
...
```json
{
  ...
  "properties": {
    "include_adult_keywords": {
      "type": "boolean",
      "description": "include keywords associated with adult content"
    },
    "language_code": {
      "type": "string",
    ...
    "sort_by": {
      "type": "string",
      "description": "Sort field (DataForSEO supports 'relevance' for Google Ads search_volume; pass null to use default server order)",
      "enum": [
        "relevance"
      ]
    }
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0367-0000-0a22036cd8ad",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0207 sec.",
      "cost": 0.09,
...
- Primary keyword volume tool. Use when you need official Google Ads search volume data.
...
- `dataforseo_labs_keyword_overview`
