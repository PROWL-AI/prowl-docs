...
Get keyword difficulty scores for up to 1000 keywords — chance of ranking in top 10.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_bulk_keyword_difficulty",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0392-0000-3381cb556839",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0416 sec.",
      "cost": 0.01224,
