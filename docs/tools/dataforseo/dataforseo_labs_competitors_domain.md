---
name: dataforseo_labs_competitors_domain
provider: DataForSEO
...
Find competitor domains based on keyword overlap — discover domains competing for similar keywords.
...
| Tags | `competitors`, `dataforseo`, `domain` |
...
```json
{
  ...
  "tool_name": "dataforseo_labs_competitors_domain",
  "params": {
    "target": "example.com"
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0386-0000-f2102a83eba0",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "13.1382 sec.",
      "cost": 0.024,
