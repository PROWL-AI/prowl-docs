---
name: dataforseo_labs_google_app_intersection
provider: DataForSEO
...
Find keywords shared across up to 20 Google Play apps.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_google_app_intersection",
  "params": {
    "app_ids": {}
  }
}
...
|-------|------|----------|---------|-------------|
| `app_ids` | object | yes |  | Dict of app IDs keyed by position string (up to 20). E.g. {'1':'org.telegram.messenger','2':'com.zhiliaoapp.musically'}. |
...
```json
{
  ...
  "properties": {
    "app_ids": {
      "type": "object",
      "description": "Dict of app IDs keyed by position string (up to 20). E.g. {'1':'org.telegram.messenger','2':'com.zhiliaoapp.musically'}."
    },
    "location_name": {
      "type": "string",
  ...
  "description": "Parameters for the DataForSEO `dataforseo_labs/google/app_intersection/live` live endpoint. Listed properties are the curated core; additional keys are accepted and forwarded verbatim to the endpoint (full field list: https://docs.dataforseo.com/v3/).",
  "required": [
    "app_ids"
  ]
}
