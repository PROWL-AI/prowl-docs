---
name: dataforseo_labs_historical_bulk_traffic_estimation
provider: DataForSEO
...
Get historical traffic estimates for domains — track organic traffic changes over time.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_historical_bulk_traffic_estimation",
  "params": {
    "targets": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0563-0000-75e5ab72e25c",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.1574 sec.",
      "cost": 0.1224,
...
- Historical traffic estimates for multiple domains — compare growth trajectories over 6-12 months.
