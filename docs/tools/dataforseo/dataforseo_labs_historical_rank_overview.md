---
name: dataforseo_labs_historical_rank_overview
provider: DataForSEO
...
Get historical domain ranking overview — track organic/paid keyword counts and traffic over time.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_historical_rank_overview",
  "params": {
    "target": "example.com"
  }
}
...
|-------|------|----------|---------|-------------|
| `correlate` | boolean | no |  | correlate data with previously obtained datasets |
...
```json
{
  ...
  "properties": {
    "correlate": {
      "type": "boolean",
      "description": "correlate data with previously obtained datasets"
    },
    "ignore_synonyms": {
      "type": "boolean",
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0406-0000-bae3992ece65",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.1742 sec.",
      "cost": 0.1272,
...
- Historical ranking metrics over time — detect rising/falling organic visibility trends and algorithm update impact.
