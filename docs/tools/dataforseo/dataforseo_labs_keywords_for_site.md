---
name: dataforseo_labs_keywords_for_site
provider: DataForSEO
...
Get keywords relevant to a domain from DataForSEO Labs — comprehensive keyword universe for any site.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_keywords_for_site",
  "params": {
    "target": "example.com"
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0398-0000-89285687077d",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "2.4045 sec.",
      "cost": 0.024,
...
- Keywords a domain is associated with in organic search — complements Google Ads keywords_for_site with organic SERP data.
