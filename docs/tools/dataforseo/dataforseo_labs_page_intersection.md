---
name: dataforseo_labs_page_intersection
provider: DataForSEO
...
Find keywords where specific pages both rank — page-level keyword overlap analysis.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_page_intersection",
  "params": {
    "pages": {}
  }
}
...
|-------|------|----------|---------|-------------|
| `pages` | object | yes |  | Dict mapping page URLs to targets, e.g. {'1': 'url1', '2': 'url2'} |
...
```json
{
  ...
  "properties": {
    "pages": {
      "type": "object",
      "description": "Dict mapping page URLs to targets, e.g. {'1': 'url1', '2': 'url2'}"
    },
    "location_name": {
      "type": "string",
...
> Profile capture status: **error** — DataForSEOError: DataForSEO task errors: 40501: Invalid Field: 'pages'.
...
- Page-level keyword overlap between two domains — more granular than domain_intersection for content optimization.
