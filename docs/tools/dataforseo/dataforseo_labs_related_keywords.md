---
name: dataforseo_labs_related_keywords
provider: DataForSEO
...
Get related keywords from Google's 'Related Searches' — semantically connected terms.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_related_keywords",
  "params": {
...
|-------|------|----------|---------|-------------|
| `depth` | integer | no |  | keyword search depth |
...
| `replace_with_core_keyword` | boolean | no |  | return data for core keyword |
...
```json
{
  ...
  "properties": {
    ...
    "replace_with_core_keyword": {
      "type": "boolean",
      "description": "return data for core keyword"
    },
    "tag": {
      "type": "string",
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0387-0000-a9bfad29a169",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0641 sec.",
      "cost": 0.01308,
