---
name: dataforseo_labs_relevant_pages
provider: DataForSEO
...
Get the most relevant pages of a domain with their rankings and traffic data.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_relevant_pages",
  "params": {
    "target": "example.com"
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0385-0000-a11cf17b29e4",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "6.3808 sec.",
      "cost": 0.024,
