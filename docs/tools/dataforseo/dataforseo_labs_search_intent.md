...
Classify search intent for up to 1000 keywords — informational, navigational, commercial, or transactional.
...
```json
{
  ...
  "tool_name": "dataforseo_labs_search_intent",
  "params": {
    "keywords": []
  }
}
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111839-1544-0541-0000-5cbfa07ea3c4",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "0.0789 sec.",
      "cost": 0.01224,
