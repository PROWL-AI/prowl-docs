---
name: dataforseo_merchant_amazon_sellers
provider: DataForSEO
...
Get sellers for an Amazon product by ASIN — compare pricing, condition, and shipping.
...
```json
{
  ...
  "tool_name": "dataforseo_merchant_amazon_sellers",
  "params": {
    "asin": "B08N5WRWNW"
  }
}
