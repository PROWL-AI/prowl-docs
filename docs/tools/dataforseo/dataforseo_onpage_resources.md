---
name: dataforseo_onpage_resources
provider: DataForSEO
...
Get page resources — images, scripts, stylesheets, and broken elements from a crawl.
...
```json
{
  ...
  "tool_name": "dataforseo_onpage_resources",
  "params": {
...
|-------|------|----------|---------|-------------|
| `relevant_pages_filters` | any[] | no |  | filter the resources by relevant pages |
| `search_after_token` | string | no |  | token for subsequent requests |
| `tag` | string | no |  | user-defined task identifier |
| `url` | string | no |  | page URL. optional field |
| `task_id` | string | yes |  |  |
...
```json
{
  ...
  "properties": {
    "relevant_pages_filters": {
      "type": "array",
      "description": "filter the resources by relevant pages"
    },
    "search_after_token": {
      "type": "string",
    ...
    "url": {
      "type": "string",
      "description": "page URL. optional field"
    },
    "task_id": {
      "type": "string"
    },
