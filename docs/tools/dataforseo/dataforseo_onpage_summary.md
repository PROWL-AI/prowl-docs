...
Get OnPage crawl summary for a task — overall site health, error counts, and optimization score.
...
```json
{
  ...
  "tool_name": "dataforseo_onpage_summary",
  "params": {
...
|-------|------|----------|---------|-------------|
| `task_id` | string | yes |  | Task ID from dataforseo_onpage_task_post |
...
```json
{
  ...
  "properties": {
    "task_id": {
      "type": "string",
      "description": "Task ID from dataforseo_onpage_task_post"
    }
  },
  "required": [
    "task_id"
  ...
  "tasks": [
    {
      ...
      "path": [
        ...
        "on_page",
        "summary",
        "03282354-1544-0216-0000-ac3a48117456"
      ],
