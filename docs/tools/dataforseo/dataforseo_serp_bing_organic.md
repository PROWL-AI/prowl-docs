---
name: dataforseo_serp_bing_organic
provider: DataForSEO
...
Get Bing organic SERP results — organic results and SERP features from Bing search.
...
```json
{
  ...
  "tool_name": "dataforseo_serp_bing_organic",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0139-0000-70ce48f0ffa5",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "2.2084 sec.",
      "cost": 0.002,
