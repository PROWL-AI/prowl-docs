---
name: dataforseo_serp_google_finance_explore
provider: DataForSEO
...
Explore Google Finance categories and market overviews (no keyword needed).
...
```json
{
  ...
  "tool_name": "dataforseo_serp_google_finance_explore",
  "params": {}
}
```
...
| `news_type` | enum(top_stories, local_market, world_markets) | no |  | financial news filters |
...
```json
{
  ...
  "properties": {
    ...
    "news_type": {
      "type": "string",
      "description": "financial news filters",
      "enum": [
        "top_stories",
        "local_market",
        "world_markets"
...
```json
{
  ...
  "tasks": [
    {
      "id": "08102039-1544-0139-0000-c484307710f8",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "2.0361 sec.",
      "cost": 0.002,
...
- Discover financial instruments and market data by keyword — find publicly traded competitors and industry ETFs.
