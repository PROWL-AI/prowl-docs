---
name: dataforseo_serp_google_images
provider: DataForSEO
...
Get Google Images SERP results — top 100 image results for a keyword.
...
```json
{
  ...
  "tool_name": "dataforseo_serp_google_images",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0139-0000-10c2226e9a37",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "4.0981 sec.",
      "cost": 0.002,
