---
name: dataforseo_serp_google_news
provider: DataForSEO
...
Get Google News SERP results — top news articles for a keyword.
...
```json
{
  ...
  "tool_name": "dataforseo_serp_google_news",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "08111838-1544-0139-0000-c492828038c0",
      "status_code": 20000,
      "status_message": "Ok.",
      "time": "12.4992 sec.",
      "cost": 0.002,
