---
name: dataforseo_serp_youtube_video_info
provider: DataForSEO
...
Get detailed YouTube video info — views, likes, description, channel, and metrics.
...
```json
{
  ...
  "tool_name": "dataforseo_serp_youtube_video_info",
  "params": {
...
```json
{
  ...
  "tasks": [
    {
      "id": "03282355-1544-0139-0000-f05636f49fac",
      "status_code": 40501,
