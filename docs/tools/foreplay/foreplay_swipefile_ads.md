...
Access your personal saved ads collection (SwipeFile) in Foreplay.
...
```json
{
  ...
  "tool_name": "foreplay_swipefile_ads",
  "params": {}
}
```
...
Saved ads with enriched URLs

Key fields: `data[].landing_page_url`, `data[].creative_media_urls`, `_url_summary`
...
- Access your personal swipefile of saved ad creatives
- Part of saved collections workflow: use alongside foreplay_get_boards for organized collections
