---
name: keywords_everywhere_credits
...
# `keywords_everywhere_credits`

Keywords Everywhere account credit balance.
...
```json
{
  ...
  "tool_name": "keywords_everywhere_credits",
  "params": {}
}
```
...
Normalized balance (the provider returns a bare single-element array)
...
- Uncached — always reflects the live balance
- Call it before large backlink pulls: 10,000 unique backlinks = 50,000 credits
