---
name: keywords_everywhere_unique_page_backlinks
...
# `keywords_everywhere_unique_page_backlinks`

Top backlinks for a single webpage, de-duplicated to one link per referring domain.
...
```json
{
  ...
  "tool_name": "keywords_everywhere_unique_page_backlinks",
  "params": {
...
|-------|------|----------|---------|-------------|
| `page` | string | yes |  | Full URL including scheme |
...
- 5x the credit cost of the raw variant — use it to count distinct referring domains for one asset
