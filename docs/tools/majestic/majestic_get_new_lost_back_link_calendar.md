---
name: majestic_get_new_lost_back_link_calendar
provider: Majestic
...
# `majestic_get_new_lost_back_link_calendar`

Daily counts of new and lost backlinks for an item — the valid date range for majestic_get_new_lost_back_links.
...
```json
{
  ...
  "tool_name": "majestic_get_new_lost_back_link_calendar",
  "params": {
    "item": "majestic.com"
  }
}
...
DataTables.Calendar rows

Key fields: `DataTables.Calendar.Data[].Date`, `DataTables.Calendar.Data[].NewLinks`, `DataTables.Calendar.Data[].LostLinks`
...
- Run before majestic_get_new_lost_back_links to pick a valid, cheap date window
