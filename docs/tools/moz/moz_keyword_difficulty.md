...
Moz Keyword Difficulty (1-100) — how hard ranking page one is, derived from the Page Authority of the sites already there.
...
```json
{
  ...
  "tool_name": "moz_keyword_difficulty",
  "params": {
    "keyword": "seo tools"
  }
}
...
keyword_metrics with difficulty

Key fields: `keyword_metrics.difficulty`
...
- Difficulty is relative to the incumbents' authority — read it next to the client's own DA, not alone
