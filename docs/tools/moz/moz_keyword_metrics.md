...
Full Moz metric set for one keyword in a single call: monthly volume, Keyword Difficulty, organic CTR, and Priority.
...
Keyword metric bundle

Key fields: `keyword_metrics.volume`, `keyword_metrics.difficulty`, `keyword_metrics.organic_ctr`, `keyword_metrics.priority`
...
- Organic CTR is the share of clicks organic results get at all — low CTR means SERP features eat the traffic
- Priority blends volume, difficulty, and CTR into one 1-100 opportunity score
