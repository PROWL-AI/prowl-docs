...
Moz Organic CTR / opportunity score for a keyword — how much of the click volume organic results actually capture once SERP features take their share.
...
```json
{
  ...
  "tool_name": "moz_keyword_opportunity",
  "params": {
    "keyword": "seo tools"
  }
}
...
keyword_metrics with organic CTR / opportunity

Key fields: `keyword_metrics.organic_ctr`
...
- A high-volume keyword with low opportunity is a trap — the SERP answers it without a click
