...
Monthly search-volume range for a keyword (Moz index).
...
keyword_metrics with the volume band

Key fields: `keyword_metrics.volume`
...
- Moz reports volume as a banded range — cross-check exact figures with keywords_everywhere_keyword_data
