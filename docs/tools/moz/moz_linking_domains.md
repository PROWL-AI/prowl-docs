...
Linking root domains for a target — the referring-domain list behind the Domain Authority score.
...
linking_domains[] rows

Key fields: `linking_domains`, `offset`
...
- Referring-domain COUNT is the durable authority signal; raw link count inflates easily
