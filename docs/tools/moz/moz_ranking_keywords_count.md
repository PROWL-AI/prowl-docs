---
name: moz_ranking_keywords_count
provider: Moz
provider_slug: moz
category: seo
...
Total number of keywords a site ranks for — one cheap number instead of a paged, row-billed pull.
...
```json
{
  ...
  "tool_name": "moz_ranking_keywords_count",
  "params": {
    "target": "moz.com"
  }
}
...
Key fields: `ranking_keyword_count`
...
- Cheapest way to compare organic footprint across a competitive set
