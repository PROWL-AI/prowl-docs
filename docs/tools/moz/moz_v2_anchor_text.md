...
Legacy Links API anchor-text profile: per-phrase link and root-domain counts for a target.
...
- Use the v3 moz_anchor_text unless you specifically need Links-API paging
- Over-weighted exact-match anchors are the penalty signal worth flagging
