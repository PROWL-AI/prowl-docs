---
name: moz_v2_global_top_root_domains
provider: Moz
provider_slug: moz
category: seo
...
The highest-authority root domains on the web by Moz's index — the benchmark set behind 'is DA 60 actually good?'.
...
```json
{
  ...
  "tool_name": "moz_v2_global_top_root_domains",
  "params": {}
}
```
...
- QUOTA TRAP: no required params — an empty body still returns and BILLS 25 rows; always pass limit
