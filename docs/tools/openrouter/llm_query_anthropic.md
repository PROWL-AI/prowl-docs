...
Ask Anthropic Claude directly what it knows about a brand, keyword, product, or concept.
...
- Use alongside llm_query_openai / _gemini / _grok / _perplexity to compare what each LLM 'knows'.
- Claude tends to give well-structured, citation-aware answers when the topic is well-documented.
