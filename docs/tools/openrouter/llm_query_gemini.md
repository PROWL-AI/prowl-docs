...
Ask Google Gemini directly what it knows about a brand, keyword, product, or concept.
...
- Use alongside llm_query_openai / _anthropic / _grok / _perplexity to compare what each LLM 'knows'.
- Gemini sometimes surfaces facts other LLMs miss for global / non-English brands.
