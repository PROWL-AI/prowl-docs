...
Ask xAI Grok directly what it knows about a brand, keyword, product, or concept.
...
- Use alongside llm_query_openai / _anthropic / _gemini / _perplexity to compare what each LLM 'knows'.
- Grok is the best of the five for X/Twitter-native brand sentiment.
