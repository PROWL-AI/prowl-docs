...
Ask OpenAI GPT directly what it knows about a brand, keyword, product, or concept.
...
- Use alongside llm_query_anthropic / _gemini / _grok / _perplexity to compare what each LLM 'knows'.
- Lower temperature (0.0-0.3) yields more deterministic factual answers.
