...
Amazon Product — detailed product info by ASIN (title, price, features, reviews, images).
...
{
  "search_metadata": {
    "id": "search_p1LMWreyyWI96XBwNeZYDKaP",
    "status": "Success",
    "created_at": "2026-03-28T20:44:03Z",
    "request_time_taken": 0.69,
    "parsing_time_taken": 0.0,
    "total_time_taken": 0.69,
    "request_url": "https://www.amazon.com/dp/B0DCCYZ1K2?th=1&psc=1",
    "html_url": "https://www.searchapi.io/api/v1/searches/search_p1LMWreyyWI96XBwNeZYDKaP.html",
    "json_url": "https://www.searchapi.io/api/v1/searches/search_p1LMWreyyWI96XBwNeZYDKaP"
  },
  "sear
...
```
...
**Chain inputs:** `{'param': '<from_template>', 'from_tool': 'amazon_search', 'extract': '?'}`
