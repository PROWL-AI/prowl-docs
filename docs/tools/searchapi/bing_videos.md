...
Bing Videos — video search via Bing.
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `suggestions`, `videos`, `ads`, `pagination`
...
{
  "search_metadata": {
    "id": "search_mR5DzpePyDIp5R0oL4YdGQno",
    "status": "Success",
    "created_at": "2026-03-28T20:44:14Z",
    "request_time_taken": 1.76,
    "parsing_time_taken": 0.03,
    "total_time_taken": 1.79,
    "request_url": "https://www.bing.com/videos/search?q=instagram.com&cc=US&first=1",
    "html_url": "https://www.searchapi.io/api/v1/searches/search_mR5DzpePyDIp5R0oL4YdGQno.html",
    "json_url": "https://www.searchapi.io/api/v1/searches/search_mR5DzpePyDIp5R0oL4Yd
...
```
