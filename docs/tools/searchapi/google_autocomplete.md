...
Google Autocomplete — get search suggestions for a query.
...
Top-level keys: `search_metadata`, `search_parameters`, `suggestions`, `verbatim_relevance`
...
| `search_parameters.client` | string |  |
| `suggestions[]` | array<object> |  |
| `suggestions[].value` | string |  |
| `suggestions[].relevance` | integer |  |
| `suggestions[].type` | string |  |
| `verbatim_relevance` | integer |  |
...
{
  "search_metadata": {
    "id": "search_d97LXP4morub2z0oMk03EOrl",
    "status": "Success",
    ...
    "request_url": null,
    "html_url": "https://www.searchapi.io/api/v1/searches/search_d97LXP4morub2z0oMk03EOrl.html",
    "json_url": "https://www.searchapi.io/api/v1/searches/search_d97LXP4morub2z0oMk03EOrl"
  },
  "search_parameters": {
    "engine": "google_autocom
...
```
