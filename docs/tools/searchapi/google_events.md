...
Google Events search — find events with date, venue, and ticket info.
...
Top-level keys: `search_metadata`, `search_parameters`, `events`
...
| `events[]` | array<object> |  |
| `events[].position` | integer |  |
| `events[].title` | string |  |
| `events[].link` | string |  |
| `events[].date` | object |  |
| `events[].duration` | string |  |
| `events[].address` | string |  |
| `events[].location` | string |  |
| `events[].thumbnail` | string |  |
...
{
  "search_metadata": {
    "id": "search_1XbZBxkZENuMAbZRLv8JaLNR",
    "status": "Success",
    "created_at": "2026-03-28T20:43:53Z",
    "request_time_taken": 3.85,
    "parsing_time_taken": 0.02,
    "total_time_taken": 3.87,
    "request_url": "https://www.google.com/search?q=instagram.com&oq=instagram.com&gl=us&hl=en&ibp=htl;events&ie=UTF-8",
    "html_url": "https://www.searchapi.io/api/v1/searches/search_1XbZBxkZENuMAbZRLv8JaLNR.html",
    "json_url": "https://www.searchapi.io/api/v1/se
...
```
