...
Google Local search — find local businesses, services, and places with reviews and ratings.
...
Top-level keys: `search_metadata`, `search_parameters`, `local_results`
...
| `local_results[].phone` | string |  |
| `local_results[].extensions[]` | array<string> |  |
...
{
  "search_metadata": {
    "id": "search_pVr1MO4QrQFD1MmZKvblzoE9",
    "status": "Success",
    "created_at": "2026-03-28T20:43:37Z",
    "request_time_taken": 6.1,
    "parsing_time_taken": 0.01,
    "total_time_taken": 6.11,
    "request_url": "https://www.google.com/search?q=instagram.com&oq=instagram.com&gl=us&hl=en&udm=1",
    "html_url": "https://www.searchapi.io/api/v1/searches/search_pVr1MO4QrQFD1MmZKvblzoE9.html",
    "json_url": "https://www.searchapi.io/api/v1/searches/search_pVr1M
...
```
