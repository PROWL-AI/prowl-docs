...
Google Place — get detailed place information (address, phone, hours, reviews) by Knowledge Graph MID (kgmid, e.g.
...
|-------|------|----------|---------|-------------|
| `kgmid` | string | yes |  | Knowledge Graph MID of the place (e.g. '/g/11b_3cn7rv') |
...
```json
{
  ...
  "properties": {
    "kgmid": {
      "type": "string",
      "description": "Knowledge Graph MID of the place (e.g. '/g/11b_3cn7rv')"
    },
    "hl": {
      "type": "string",
...
```json
{
  "error": "Missing required parameter kgmid."
}
```
...
**Chain inputs:** `{'param': 'kgmid', 'from_tool': 'google_maps', 'extract': '_custom_maps_kgmid'}`
