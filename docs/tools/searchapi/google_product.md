...
Google Product — detailed product info from Google Shopping.
...
|-------|------|----------|---------|-------------|
| `product_token` | string | no |  | Product token from google_shopping results |
| `product_id` | string | no |  | Google product ID |
