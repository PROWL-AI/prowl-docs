...
Yandex Web Search — Russian search engine.
...
| `lang` | string | no |  | Interface language code (e.g. 'ru') |
| `location` | string | no |  | Location for geo-targeted results |
...
```json
{
  ...
  "properties": {
    ...
    "lang": {
      "type": "string",
      "description": "Interface language code (e.g. 'ru')"
    },
    "location": {
      "type": "string",
