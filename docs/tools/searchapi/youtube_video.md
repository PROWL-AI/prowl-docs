...
YouTube Video — detailed video metadata (title, description, likes, views, channel).
...
Top-level keys: `search_metadata`, `search_parameters`, `video`, `channel`, `comment`, `key_moments`, `chapters`, `available_transcripts_languages`, `pagination`
...
| `video.id` | string |  |
| `video.title` | string |  |
| `video.length_seconds` | integer |  |
| `video.views` | integer |  |
| `video.likes` | integer |  |
| `video.author` | string |  |
| `video.category` | string |  |
| `video.published_time` | string |  |
...
{
  "search_metadata": {
    "id": "search_jOZRYa4201HBPgg2jklD6mVx",
    "status": "Success",
    "created_at": "2026-03-28T21:56:34Z",
    "request_time_taken": 1.46,
    "parsing_time_taken": 0.04,
    "total_time_taken": 1.51,
    "request_url": "https://www.youtube.com/watch?v=2YSB468mn4M",
    "html_url": "https://www.searchapi.io/api/v1/searches/search_jOZRYa4201HBPgg2jklD6mVx.html",
    "json_url": "https://www.searchapi.io/api/v1/searches/search_jOZRYa4201HBPgg2jklD6mVx"
  },
  "search_
...
```
