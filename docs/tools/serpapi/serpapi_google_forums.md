...
Google Forums / discussion results via SerpAPI.
...
```json
{
  ...
  "tool_name": "serpapi_google_forums",
  "params": {
    "q": "example query"
  }
}
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `organic_results`, `serpapi_pagination`
...
| `search_metadata.google_forums_url` | string |  |
...
| `organic_results[].redirect_link` | string |  |
| `organic_results[].displayed_meta` | string |  |
| `organic_results[].favicon` | string |  |
...
{
  "search_metadata": {
    "id": "69c83d7e874d5093bda01f31",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/kzha9_dxDCdRkX3S63i4tQ/69c83d7e874d5093bda01f31.json",
    "created_at": "2026-03-28 20:43:42 UTC",
    "processed_at": "2026-03-28 20:43:42 UTC",
    "google_forums_url": "https://www.google.com/search?q=instagram.com&hl=en&device=desktop&udm=18",
    "raw_html_file": "https://serpapi.com/searches/kzha9_dxDCdRkX3S63i4tQ/69c83d7e874d5093bda01f31.html",
    "t
...
```
