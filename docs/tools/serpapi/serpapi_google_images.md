...
```json
{
  ...
  "tool_name": "serpapi_google_images",
  "params": {
    "q": "example query"
  }
}
...
| `ijn` | integer | no |  | Page number for image results (0-indexed) |
| `safe` | enum(active, off) | no |  | Safe search |
...
```json
{
  ...
  "properties": {
    ...
    "ijn": {
      "type": "integer",
      "description": "Page number for image results (0-indexed)"
    },
    "safe": {
      "type": "string",
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `images_results`, `serpapi_pagination`
...
| `search_metadata.google_images_url` | string |  |
...
| `search_information.image_results_state` | string |  |
| `images_results[]` | array<object> |  |
| `images_results[].position` | integer |  |
| `images_results[].thumbnail` | string |  |
| `images_results[].related_content_id` | string |  |
| `images_results[].serpapi_related_content_link` | string |  |
...
{
  "search_metadata": {
    "id": "69c83d79a3882db0bb39a441",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/qJxb3C4J82yDHXlRFi75gQ/69c83d79a3882db0bb39a441.json",
    "created_at": "2026-03-28 20:43:37 UTC",
    "processed_at": "2026-03-28 20:43:37 UTC",
    "google_images_url": "https://www.google.com/search?udm=2&q=instagram.com&oq=instagram.com&hl=en&gl=us",
    "raw_html_file": "https://serpapi.com/searches/qJxb3C4J82yDHXlRFi75gQ/69c83d79a3882db0bb39a441.html",
...
```
