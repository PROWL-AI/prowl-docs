...
```json
{
  ...
  "tool_name": "serpapi_google_patents",
  "params": {
    "q": "example query"
  }
}
...
```json
{
  ...
  "properties": {
    ...
    "patent_number": {
      "type": "string",
      "description": "Specific patent number"
    },
    "country": {
      "type": "string",
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `organic_results`, `summary`, `pagination`, `serpapi_pagination`
...
| `search_metadata.google_patents_url` | string |  |
...
| `organic_results[].patent_link` | string |  |
...
{
  "search_metadata": {
    "id": "69c83d81a39c28ef3dbd1986",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/hne0udDJlYsAUaKbMgw98g/69c83d81a39c28ef3dbd1986.json",
    "created_at": "2026-03-28 20:43:45 UTC",
    "processed_at": "2026-03-28 20:43:45 UTC",
    "google_patents_url": "https://patents.google.com/xhr/query?url=q%3Dinstagram.com",
    "raw_html_file": "https://serpapi.com/searches/hne0udDJlYsAUaKbMgw98g/69c83d81a39c28ef3dbd1986.html",
    "prettify_html_f
...
```
