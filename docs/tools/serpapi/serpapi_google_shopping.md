...
| Tags | `google`, `serp`, `serpapi`, `serpapi_serp`, `shopping` |
...
```json
{
  ...
  "tool_name": "serpapi_google_shopping",
  "params": {
    "q": "example query"
  }
}
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `filters`, `error`
...
{
  "search_metadata": {
    "id": "69c83d7bae39f35097109d76",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/dLRhcEVbbjyVjLP3NRl_Vw/69c83d7bae39f35097109d76.json",
    "created_at": "2026-03-28 20:43:39 UTC",
    "processed_at": "2026-03-28 20:43:39 UTC",
    "google_shopping_url": "https://www.google.com/search?udm=28&q=instagram.com&hl=en&gl=us",
    "raw_html_file": "https://serpapi.com/searches/dLRhcEVbbjyVjLP3NRl_Vw/69c83d7bae39f35097109d76.html",
    "total_ti
...
```
