...
Google Videos search via SerpAPI.
...
| Tags | `google`, `serp`, `serpapi`, `serpapi_serp`, `video` |
...
```json
{
  ...
  "tool_name": "serpapi_google_videos",
  "params": {
    "q": "example query"
  }
}
...
Top-level keys: `search_metadata`, `search_parameters`, `search_information`, `video_results`, `pagination`, `serpapi_pagination`
...
| `search_metadata.google_videos_url` | string |  |
...
{
  "search_metadata": {
    "id": "69c83d7bbca7e59356cf1667",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/wNCrR1ERykum4E6l5WLbiA/69c83d7bbca7e59356cf1667.json",
    "created_at": "2026-03-28 20:43:39 UTC",
    "processed_at": "2026-03-28 20:43:39 UTC",
    "google_videos_url": "https://www.google.com/search?q=instagram.com&hl=en&gl=us&udm=7",
    "raw_html_file": "https://serpapi.com/searches/wNCrR1ERykum4E6l5WLbiA/69c83d7bbca7e59356cf1667.html",
    "total_time_
...
```
