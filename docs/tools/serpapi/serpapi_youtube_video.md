...
YouTube video details via SerpAPI.
...
| Tags | `serp`, `serpapi`, `serpapi_serp`, `video`, `youtube` |
...
```json
{
  ...
  "tool_name": "serpapi_youtube_video",
  "params": {
...
Top-level keys: `search_metadata`, `search_parameters`, `title`, `thumbnail`, `channel`, `views`, `extracted_views`, `likes`, `extracted_likes`, `published_date`, `description`, `chapters`, `related_videos`, `related_videos_next_page_token`, `end_screen_videos`, `comments_next_page_token`, `comments_sorting_token`, `transcript`
...
| `search_metadata.youtube_video_url` | string |  |
...
| `channel.extracted_subscribers` | integer |  |
| `channel.verified` | boolean |  |
| `views` | string |  |
| `extracted_views` | integer |  |
| `likes` | string |  |
...
{
  "search_metadata": {
    "id": "69c85022f357f677f1cdee99",
    "status": "Success",
    "json_endpoint": "https://serpapi.com/searches/LrvScSce1aIpqlFEijraRw/69c85022f357f677f1cdee99.json",
    "created_at": "2026-03-28 22:03:14 UTC",
    "processed_at": "2026-03-28 22:03:14 UTC",
    "youtube_video_url": "https://www.youtube.com/watch?v=b2HNVEP4vig",
    "raw_html_file": "https://serpapi.com/searches/LrvScSce1aIpqlFEijraRw/69c85022f357f677f1cdee99.html",
    "prettify_html_file": "https://s
...
```
