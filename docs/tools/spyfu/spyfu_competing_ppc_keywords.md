---
name: spyfu_competing_ppc_keywords
provider: SpyFu
provider_slug: spyfu
category: seo
...
Head-to-head PPC keyword comparison between two domains (Kombat API).
...
```json
{
  ...
  "tool_name": "spyfu_competing_ppc_keywords",
  "params": {
...
```json
{
  ...
  "traceId": "00-793dd76a98aff5277b521e2bbc8209f0-6eba114ec906b384-00"
}
```
...
- Kombat tool — head-to-head PPC keyword comparison between two domains
- Combine with spyfu_competing_seo_keywords for full keyword overlap analysis
- Use with spyfu_where_they_outrank_you and spyfu_organic_outranking_keywords for complete Kombat
