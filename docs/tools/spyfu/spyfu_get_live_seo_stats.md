...
# `spyfu_get_live_seo_stats`

Get real-time SEO statistics for a domain including current organic rankings, estimated traffic, and keyword counts.
...
```json
{
  ...
  "tool_name": "spyfu_get_live_seo_stats",
  "params": {
    "domain": "example.com"
  }
}
...
Top-level keys: `resultCount`, `domain`, `url`, `totalOrganicResults`, `monthlyOrganicClicks`, `monthlyOrganicClickValue`, `totalSearchVolume`
...
```json
{
  ...
  "totalOrganicResults": 489300977,
  "monthlyOrganicClicks": 469357462,
  "monthlyOrganicClickValue": 1400553036.694333,
  "totalSearchVolume": 53919417128
}
```
...
- Quick SEO health check — faster than spyfu_get_domain_stats but no historical trend
- Use when you just need current organic rankings and traffic snapshot
