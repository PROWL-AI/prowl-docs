---
name: spyfu_get_ppc_competitors
provider: SpyFu
provider_slug: spyfu
category: seo
...
Get top PPC-only competitors — domains competing in paid search only.
...
```json
{
  ...
  "tool_name": "spyfu_get_ppc_competitors",
  "params": {
    "domain": "example.com"
  }
}
...
```json
{
  ...
  "results": [
    ...
    {
      "domain": "autorepair-wichitafalls.com",
      "commonTerms": 34,
      "rank": 0.0006058871
    },
    {
      "domain": "tiresites.net",
      "commonTerms": 21,
      "rank": 0.0005550251
    },
    {
...
- SEO analysis workflow: focused PPC competitor list (Google Ads only)
- For combined organic+paid competitors, use spyfu_get_combined_competitors instead
- Pair with spyfu_get_seo_competitors for organic vs paid competitor comparison
