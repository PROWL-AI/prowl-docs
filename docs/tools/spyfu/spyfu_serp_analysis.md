...
Get SERP analysis showing which domains rank for a specific keyword.
...
|-------|------|----------|---------|-------------|
| `query` | string | yes |  | Keyword to analyze SERP for |
...
```json
{
  ...
  "status": 400,
  "traceId": "00-800d9d762d262441caf7c2d44f367590-a6bfe385eb4f0dea-00",
  "errors": {
    "Keyword": [
...
- Keyword-level ad research: shows current SERP landscape and top-ranking domains
- Combine with spyfu_get_term_ad_history_with_stats for keyword ad performance
